...
object NativeMethods {
    ...
    // --- Model Metadata --- NEW
    external fun llama_model_meta_val_str(model: LlamaModelPointer, key: String): String?
    external fun llama_model_meta_val_int(model: LlamaModelPointer, key: String): Int
    external fun llama_model_token_to_piece(model: LlamaModelPointer, token: llama_token): String?
