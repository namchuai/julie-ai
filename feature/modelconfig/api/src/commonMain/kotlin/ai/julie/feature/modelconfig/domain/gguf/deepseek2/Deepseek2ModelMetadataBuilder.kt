...
class Deepseek2ModelMetadataBuilder : GgufMetadataBuilder {
    val architecture: SupportedArchitecture = SupportedArchitecture.DEEPSEEK2
...
//        if (ropeDimensionCount == null) missingFields.add("llama.rope.dimension_count")
    ...
    companion object Companion {
         ...
         */
        fun create(): Deepseek2ModelMetadataBuilder = Deepseek2ModelMetadataBuilder()
    }
}